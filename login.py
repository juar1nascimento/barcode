...
# Altere este link caso deseje redirecionar para o portal do GLPI/AD
...
def renderizar_login() -> bool:
    ...
    st.markdown("""
        <style>
            ...
            /* Botão 'Esqueceu sua senha?' simulando link HTML */
    ...
    with col_center:
        ...
        if st.session_state.esqueci_senha:
            ...
            st.info("Entre em contato com o suporte de TI para solicitar a redefinição de sua senha.")
        ...
        with st.form(key="glpi_login_form", clear_on_submit=False):
            ...
            # Botão invisível do Streamlit formatado como link para acionar a ação
