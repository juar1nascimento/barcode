...
# ==============================================================================
# AUDITORIA DEFINITIVA — MENU "TIPO DE PATRIMÔNIO"
# Regra global para TODAS as UBS e URS.
# ==============================================================================
...
def opcoes_tipo_patrimonio():
    """
    FONTE ÚNICA DO MENU.
    Nunca usar dados do Google Sheets, fabricantes ou EQUIPAMENTOS_OPCOES
    para montar este selectbox.
    """
    return list(TIPOS_PATRIMONIO_PERMITIDOS)

def validar_tipo_patrimonio(tipo: str) -> str:
    """Rejeita qualquer valor que não esteja na lista oficial."""
...
if pagina == "1. Cadastro / Leitor de Código de Barras":
    ...
    with col1:
        ...
        tipo_equipamento = st.selectbox("Selecione o Tipo de Patrimônio:", opcoes_tipo_patrimonio(), key="tipo_patrimonio_auditoria_v3")
